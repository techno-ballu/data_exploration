...
#                                              style = "default", disabled = FALSE)),
                  ...
                  )), value = "outliers"),type = "tabs",id = "clean-data")
              )),                
tabPanel("Explore data",fluidPage(tabsetPanel(
    type = "pills",
...
# tabPanel("Transform data",fluidPage(tabsetPanel(
#   type = "pills",
#   tabPanel("Numerical transformations",
#            fluidPage(
...
#     ))
# ))),
# tabPanel("Impute data",fluidPage(h3("Impute missing values"))),
# tabPanel("Subset, collinearity & selection",fluidPage(tabsetPanel(
#   type = "pills",
...
#                                                                   ))
# )))),
# tabPanel("Model Data",fluidPage(tabsetPanel(
#   type = "pills",
#   tabPanel("Held out test",h3("Set aside hold-out test data")
#   ),
#   tabPanel("Define RSS",
#            h3("Set up the random straitified splits")
#   ),
#   tabPanel("Iterations & algorithms",
#            h3("This is where we can transform features applying natural logarithms, box-plot transforms, centering, scaling & PCA.")
#   ),
#   tabPanel("Training",
#            h3("Training")
#   ),
